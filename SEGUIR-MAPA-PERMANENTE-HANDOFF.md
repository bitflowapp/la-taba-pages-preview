...
Rama `feature/taba2-tracking-always-on-map`, worktree
`D:\1212\worktrees\taba2-tracking-always-map`, sobre `eda13f8`
(`release/taba2-pilot-rc2-operational`, la punta que hoy sirve staging tras el
deployment `c184ffb6`). Sin push, sin producción, sin migraciones, sin tocar el
Rider Android y sin tocar precisión, redondeo ni GPS.
...
Capturas en `D:\1212\artifacts\taba2-seguir-mapa-permanente\{antes,despues}\`:
