# Demo para Walter — PedidoPropio, canal propio de pedidos
...
| # | Pantalla | Qué decir |
|---|----------|-----------|
| 1 | Presentación (`pitch`) | "Esto es PedidoPropio: tu propio canal de pedidos, con tu marca. Sin comisiones de plataformas ni audios sueltos." Tocar **Probar la demo**. |
...
> **"¿Te serviría que los pedidos de tu comercio entren así, ordenados,
