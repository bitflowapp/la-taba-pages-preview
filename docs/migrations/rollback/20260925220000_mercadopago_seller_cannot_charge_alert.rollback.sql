-- Rollback de 20260925220000: vuelve a la reconciliación de 20260810140000, sin
-- la alerta MERCADOPAGO_SELLER_CANNOT_CHARGE. Las alertas ya abiertas con ese
-- código se resuelven en la siguiente corrida del barrido.
