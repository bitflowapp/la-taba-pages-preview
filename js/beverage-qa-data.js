...
export const products = [
  fixture('qa-promo-bebidas', 'Coca-Cola Original 1,5 L x6', 'gaseosas', 'Pack x6 · Botella 1,5 L', {
    ...
    brand: 'Coca-Cola', variant: 'Original', capacityValue: 1.5, capacityUnit: 'l', packageType: 'pack', unitsPerPack: 6, identityStatus: 'EXACTA', rightsStatus: 'APROBADOS',
  }),
  fixture('qa-gaseosa-cola', 'Sprite 1,5 L x6', 'gaseosas', 'Pack x6 · Botella 1,5 L', {
    ...
    brand: 'Sprite', variant: 'Original', capacityValue: 1.5, capacityUnit: 'l', packageType: 'pack', unitsPerPack: 6, identityStatus: 'EXACTA', rightsStatus: 'APROBADOS',
  }),
  fixture('qa-gaseosa-lima-limon', 'Fanta Naranja 1,5 L x6', 'gaseosas', 'Pack x6 · Botella 1,5 L', {
    ...
    previewCatalogApproved: true, unit: 'pack', unitLabel: 'Pack x6', stock: 10,
    brand: 'Fanta', variant: 'Naranja', capacityValue: 1.5, capacityUnit: 'l', packageType: 'pack', unitsPerPack: 6, identityStatus: 'EXACTA', rightsStatus: 'APROBADOS',
  }),
  fixture('qa-energetica', 'Monster Energy Original Green 473 ml x6', 'energeticas', 'Pack x6 · Lata 473 ml', {
    ...
    brand: 'Monster', variant: 'Energy Original Green', capacityValue: 473, capacityUnit: 'ml', packageType: 'pack', unitsPerPack: 6, identityStatus: 'EXACTA', rightsStatus: 'APROBADOS',
  }),
  fixture('qa-jugo-naranja', 'Monster Energy Mango Loco 473 ml x6', 'energeticas', 'Pack x6 · Lata 473 ml', {
    ...
    brand: 'Monster', variant: 'Energy Mango Loco', capacityValue: 473, capacityUnit: 'ml', packageType: 'pack', unitsPerPack: 6, identityStatus: 'EXACTA', rightsStatus: 'APROBADOS',
  }),
  fixture('qa-isotonica', 'Monster Energy Ultra White Zero 473 ml x6', 'energeticas', 'Pack x6 · Lata 473 ml', {
    ...
    previewCatalogApproved: true, unit: 'pack', unitLabel: 'Pack x6', price: QA_PRICES.specialty, stock: 6,
    brand: 'Monster', variant: 'Energy Ultra White Zero', capacityValue: 473, capacityUnit: 'ml', packageType: 'pack', unitsPerPack: 6, identityStatus: 'EXACTA', rightsStatus: 'APROBADOS',
  }),
  fixture('qa-picada', 'Monster Energy Ultra Peachy Keen 473 ml x6', 'energeticas', 'Pack x6 · Lata 473 ml', {
    ...
    previewCatalogApproved: true, unit: 'pack', unitLabel: 'Pack x6', price: QA_PRICES.specialty, stock: 6,
    brand: 'Monster', variant: 'Energy Ultra Peachy Keen', capacityValue: 473, capacityUnit: 'ml', packageType: 'pack', unitsPerPack: 6, identityStatus: 'EXACTA', rightsStatus: 'APROBADOS',
  }),
  ...
  fixture('qa-cerveza', 'Heineken Original 473 ml', 'cervezas', 'Lata 473 ml', {
    ...
    previewCatalogApproved: true, price: QA_PRICES.alcoholic, stock: 3,
  ...
  fixture('qa-agua-mineral', 'Villavicencio Sin Gas 500 ml', 'aguas', 'Botella 500 ml', {
    ...
    previewCatalogApproved: true, stock: 12,
  ...
  fixture('qa-hielo', 'Corona Extra 355 ml x12', 'cervezas', 'Pack x12 · Botella 355 ml', {
