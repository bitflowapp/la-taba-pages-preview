...
const PANTALLAS = [
  ...
  // La bandeja donde el duenio decide quien entra. Faltaba en este recorrido
  // por la misma razon por la que faltaba en la navegacion: se agrego despues.
  { id: 'team-access', vista: 'team-access', titulo: 'Solicitudes de acceso' },
