...
const result=spawnSync('cmd.exe',['/d','/c','gradlew.bat',...(tasks.length?tasks:[':app:testDebugUnitTest',':app:assembleDebug',':app:assembleRelease',':app:assembleDebugAndroidTest']),'--console=plain'],{
