...
Write-Host 'Callback: https://wwcpogltfgzgkrlilbcd.supabase.co/functions/v1/mercadopago-oauth-callback'
Write-Host 'Webhook:  https://wwcpogltfgzgkrlilbcd.supabase.co/functions/v1/mercadopago-webhook'
