...
const steps = [
  ['npx', ['--yes', 'deno@2.6.1', 'test', '--node-modules-dir=auto', 'supabase/functions/_shared/mercadopago-webhook-signature.deno.ts']],
  ['node', ['--import', './tests/test-bootstrap.mjs', '--test', '--test-concurrency=1', 'tests/mercadopago-webhook.test.mjs']],
];
