...
try {
  ...
  if(!focused){
    ...
    const canonicalTests=['business_windows_scanner_fiscal_test.sql','mercadopago_seller_oauth.local.sql',
      ...
      'mercadopago_availability_requires_seller.local.sql'];
    ...
    assert.equal(assertions,390);
    console.log('CANONICAL_PGTAP: 250 + 44 least-privilege + 50 reparto-propio + 37 ventana QA/columnas privadas/pausa + 9 Mercado Pago sólo con vendedor conectado assertions PASS');
