...
const CACHE_NAME = 'la-taba-runtime-v60-seguimiento-sin-replay';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=48',
  './styles/tokens.css?v=48',
  './styles/common.css?v=48',
  './styles/storefront.css?v=48',
  './styles/catalog.css?v=48',
  './styles/checkout.css?v=48',
  './styles/profile.css?v=48',
  './styles/showcase.css?v=48',
  './styles/tracking.css?v=48',
  './styles/business.css?v=48',
  './styles/rider.css?v=48',
  './styles/responsive.css?v=48',
  './styles/brand-home.css?v=48',
