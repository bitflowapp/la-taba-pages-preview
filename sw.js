...
const CACHE_NAME = 'la-taba-runtime-v36-beverage-home-unit-preview';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=36',
  './styles/tokens.css?v=36',
  './styles/common.css?v=36',
  './styles/storefront.css?v=36',
  './styles/catalog.css?v=36',
  './styles/checkout.css?v=36',
  './styles/tracking.css?v=36',
  './styles/business.css?v=36',
  './styles/rider.css?v=36',
  './styles/responsive.css?v=36',
