...
const CACHE_NAME = 'la-taba-runtime-v38-unit-storefront';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=38',
  ...
  './styles/storefront.css?v=38',
  './styles/catalog.css?v=38',
  './styles/checkout.css?v=38',
  './styles/tracking.css?v=38',
  './styles/business.css?v=38',
  './styles/rider.css?v=38',
  ...
  './js/core/storage.js',
  './js/core/storefront-filters.js?v=38',
