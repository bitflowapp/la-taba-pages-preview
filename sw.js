...
const CACHE_NAME = 'la-taba-runtime-v52-punto-en-el-panel';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=44',
  './styles/tokens.css?v=44',
  './styles/common.css?v=44',
  './styles/storefront.css?v=44',
  './styles/catalog.css?v=44',
  './styles/checkout.css?v=44',
  './styles/profile.css?v=44',
  './styles/showcase.css?v=44',
  './styles/tracking.css?v=44',
  './styles/business.css?v=44',
  './styles/rider.css?v=44',
  './styles/responsive.css?v=44',
  './styles/brand-home.css?v=44',
