...
const CACHE_NAME = 'la-taba-runtime-v45-gondola';
const ASSETS = [
  './',
  './index.html',
  './styles.css?v=41',
  './styles/tokens.css?v=41',
  './styles/common.css?v=41',
  './styles/storefront.css?v=41',
  './styles/catalog.css?v=41',
  './styles/checkout.css?v=41',
  './styles/profile.css?v=41',
  './styles/showcase.css?v=41',
  './styles/tracking.css?v=41',
  './styles/business.css?v=41',
  './styles/rider.css?v=41',
  './styles/responsive.css?v=41',
  './styles/brand-home.css?v=41',
