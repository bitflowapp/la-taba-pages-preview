...
test('service worker caches only existing GitHub Pages assets', () => {
  ...
  assert.equal(cacheNameMatch[1], 'la-taba-runtime-v46-tracking-nocturno');
  ...
  assert.ok(assets.includes('./styles.css?v=42'));
  assert.ok(assets.includes('./styles/storefront.css?v=42'));
  assert.ok(assets.includes('./styles/responsive.css?v=42'));
  assert.ok(assets.includes('./styles/showcase.css?v=42'));
