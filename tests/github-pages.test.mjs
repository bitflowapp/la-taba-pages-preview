...
test('service worker caches only existing GitHub Pages assets', () => {
  ...
  assert.equal(cacheNameMatch[1], 'la-taba-runtime-v38-unit-storefront');
  ...
  assert.ok(assets.includes('./styles.css?v=38'));
  assert.ok(assets.includes('./styles/storefront.css?v=38'));
  assert.ok(assets.includes('./styles/responsive.css?v=38'));
  assert.ok(assets.includes('./js/app.js?v=38'));
  ...
  assert.ok(assets.includes('./js/core/storefront-filters.js?v=38'));
