...
test('service worker caches only existing GitHub Pages assets', () => {
  ...
  assert.equal(cacheNameMatch[1], 'la-taba-runtime-v87-lanzamiento-comercial');
  ...
  assert.ok(assets.includes('./styles.css?v=55'));
  assert.ok(assets.includes('./styles/storefront.css?v=55'));
  assert.ok(assets.includes('./styles/responsive.css?v=55'));
  assert.ok(assets.includes('./styles/showcase.css?v=55'));
