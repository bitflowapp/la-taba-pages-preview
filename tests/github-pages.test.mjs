...
test('service worker caches only existing GitHub Pages assets', () => {
  ...
  assert.equal(cacheNameMatch[1], 'la-taba-runtime-v61-cliente-comercial-mapa-permanente');
  ...
  assert.ok(assets.includes('./styles.css?v=49'));
  assert.ok(assets.includes('./styles/storefront.css?v=49'));
  assert.ok(assets.includes('./styles/responsive.css?v=49'));
  assert.ok(assets.includes('./styles/showcase.css?v=49'));
  assert.ok(assets.includes('./js/app.js?v=41'));
