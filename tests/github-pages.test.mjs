...
test('service worker caches only existing GitHub Pages assets', () => {
  ...
  assert.equal(cacheNameMatch[1], 'la-taba-runtime-v45-gondola');
  ...
  assert.ok(assets.includes('./styles/storefront.css?v=41'));
  assert.ok(assets.includes('./styles/responsive.css?v=41'));
  assert.ok(assets.includes('./styles/showcase.css?v=41'));
